...
def plot_pair(dat_1,dat_2,out_loc):
	...
	ax.set_ylabel(r"$P(n)$", fontsize=18)
	...
	if CLIP_1:
		fig_name = 'total_jobs_pdf_comp_clip.eps'
	else:
		fig_name = 'total_jobs_pdf_comp.eps'
...
#Path to actors and actresses total jobs density funcion data.
d_loc_1 = "actors_total_jobs_pdf.txt"
d_loc_2 = "actresses_total_jobs_pdf.txt"

#Location of desired output folder for activity density function data.
